...
def intial_buckets(bin_stream):
    ...
    # Counting the no of 1's for first 32 bits (accurate count)
    oc = 0  # one count
    c = 0
    n = 0
    bucket_counter = 0
...
Consider the problem of detecting emails that are phishing attacks. The most common approach
is to build a model of phishing emails, perhaps by examining emails that people have recently
reported as"""
